...
static void usage()
{
	WriteErrorMessage(
		...
		"\e[31m*\e[0m \e[3;90mrRNA reads mapped to T2T reference (v2, chr1 length: 248387328 bp,\n"
		...
		"  \e[3;90mInternal control (IC) sequences counts are reported if applicable.\e[0;0m\n",
