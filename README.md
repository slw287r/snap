...
The IC coordinates are now parsed automatically if the contig name begins with `IC`.

</details>

<details><summary><h3>Get padded intervals for host ribosomal RNA, HSK</h3></summary>
